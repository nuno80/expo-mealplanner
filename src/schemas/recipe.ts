...
/**
 * Protein source for meal plan rotation (Mediterranean Diet guidelines)
 */
export const ProteinSourceSchema = z.enum([
  "legumes", // Legumi (3-5x/week) - ceci, fagioli, lenticchie
  "fish", // Pesce (3-4x/week) - preferire azzurro per Omega-3
  "white_meat", // Carne bianca (2-3x/week) - pollo, tacchino
  "eggs", // Uova (2-4x/week)
  "dairy", // Latticini (2-3x/week) - preferire freschi e magri
  "red_meat", // Carne rossa (0-1x/week) - limitare fortemente
  "plant_based", // Proteine vegetali - tofu, seitan, tempeh
  "mixed", // Mix di fonti
  "none", // Senza fonte proteica significativa (es. alcuni snack)
]);
